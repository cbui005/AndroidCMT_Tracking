...
DetectorCascade::DetectorCascade()
{
  ...
  varianceFilter->enabled =  m_settings->m_varianceFilterEnabled;
  ensembleClassifier->enabled = m_settings->m_ensembleClassifierEnabled;
  nnClassifier->enabled = m_settings->m_nnClassifierEnabled;

        // classifier
    useShift = m_settings->m_useProportionalShift;
    shift = m_settings->m_proportionalShift;
    minScale = m_settings->m_minScale;
    maxScale = m_settings->m_maxScale;
    minSize = m_settings->m_minSize;
    numTrees = m_settings->m_numTrees;
    numFeatures = m_settings->m_numFeatures;
    nnClassifier->thetaTP = m_settings->m_thetaP;
    nnClassifier->thetaFP = m_settings->m_thetaN;
